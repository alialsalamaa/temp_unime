...
python main.py \
  ...
  --crop_size 96 \
  --seed 42 \
  --uni_encoder_name UniEncoderNano \
  --uni_encoder_checkpoint log_pretrain/BRATS2023-42-Normal/UniEncoderNano/ema_best_checkpoint.pth \
  --wandb_mode online \
  --wandb_project UniME \
